...
const ProductionMonitoring = () => {
  ...
  const canManageProduction = Boolean(user);
    ...
    <div className="flex flex-col h-[100dvh] bg-gray-950 text-white overflow-hidden">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="flex-1 flex flex-col overflow-hidden min-w-0">
          ...
          {!loading && error && machines.length > 0 && (
            <div className="flex-shrink-0 flex items-start gap-2.5 border-b border-amber-500/20 bg-amber-500/10 px-4 py-2.5 text-xs text-amber-300">
